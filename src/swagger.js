const swaggerDefinition = {
  ...
  components: {
    ...
    schemas: {
      ...
      Reserva: {
        type: 'object',
        properties: {
          id: { type: 'string', format: 'uuid', example: '48D1D43E-AFBC-4C83-85C0-C9D1521B48A8' },
          hospede_id: { type: 'string', format: 'uuid', example: '9825D286-1C60-4497-B1BF-076D0470BF52' },
          quarto_id: { type: 'string', format: 'uuid', example: '187B44C0-9BA1-4F43-9165-A29BB11C1248' },
          data_checkin: { type: 'string', format: 'date-time', example: '2026-05-12T00:00:00.000Z' },
          data_checkout: { type: 'string', format: 'date-time', example: '2026-05-15T00:00:00.000Z' },
          qtd_adultos: { type: 'integer', example: 2 },
          qtd_criancas: { type: 'integer', example: 0 },
          valor: { type: 'number', format: 'float', example: 1350.00 },
          codigo: { type: 'string', example: 'RES-1778598188919' },
          status: { type: 'string', enum: ['confirmada', 'check-in', 'check-out', 'cancelada', 'no-show'], example: 'confirmada' },
          canal: { type: 'string', example: 'website' },
          hospede_nome: { type: 'string', nullable: true, example: 'Mariana Oliveira' },
          hospede_email: { type: 'string', nullable: true, example: 'mariana@email.com' },
          hospede_cpf: { type: 'string', nullable: true, example: '123.456.789-00' },
          quarto_numero: { type: 'string', nullable: true, example: '204' },
          categoria_descricao: { type: 'string', nullable: true, example: 'Quarto Deluxe' },
          pagamento_financeiro: { $ref: '#/components/schemas/PagamentoFinanceiroCheckout' },
        },
      },
      FinanceiroTransacao: {
        type: 'object',
        properties: {
          data: { type: 'string', format: 'date-time', example: '2026-05-21T12:30:00.000Z' },
          descricao: { type: 'string', example: 'Pagamento checkout - hospedagem - Hospede Teste - quarto 901' },
          origem: { type: 'string', example: 'Hospede Teste / Quarto 901' },
          tipo: { type: 'string', example: 'RECEITA' },
          categoria: { type: 'string', example: 'HOSPEDAGEM' },
          status: { type: 'string', example: 'liquidado' },
          valor: { type: 'number', format: 'float', example: 360.0 },
          reservaId: { type: 'string', format: 'uuid', nullable: true },
          hospedeId: { type: 'string', format: 'uuid', nullable: true },
          quartoId: { type: 'string', format: 'uuid', nullable: true },
        },
      },
      PagamentoFinanceiroCheckout: {
        type: 'object',
        properties: {
          reservaId: { type: 'string', format: 'uuid' },
          hotelId: { type: 'string', format: 'uuid' },
          hospedeId: { type: 'string', format: 'uuid' },
          quartoId: { type: 'string', format: 'uuid' },
          hospede: { type: 'string', example: 'Hospede Teste Financeiro' },
          quarto: { type: 'string', example: '901' },
          tipoQuarto: { type: 'string', example: 'Suite Teste' },
          diasReserva: { type: 'integer', example: 3 },
          valorDiaria: { type: 'number', format: 'float', example: 120.0 },
          valorEstadia: { type: 'number', format: 'float', example: 360.0 },
          valorConsumoExtra: { type: 'number', format: 'float', example: 45.0 },
          valorTotal: { type: 'number', format: 'float', example: 405.0 },
      ...
      FinanceiroDetalhamentoEstadia: {
        type: 'object',
        properties: {
          id: { type: 'string', format: 'uuid' },
          codigo: { type: 'string', example: 'RES-1778598188919' },
          data: { type: 'string', format: 'date-time' },
          dataCheckout: { type: 'string', format: 'date-time' },
          status: { type: 'string', example: 'finalizado' },
          quarto: { type: 'string', example: '901' },
          tipo: { type: 'string', example: 'Suite Teste' },
          hospede: { type: 'string', example: 'Hospede Teste Financeiro' },
          valorDiaria: { type: 'number', format: 'float', example: 120.0 },
          valorConsumoExtra: { type: 'number', format: 'float', example: 45.0 },
          noitesNoPeriodo: { type: 'integer', example: 3 },
          total: { type: 'number', format: 'float', example: 405.0 },
        },
      },
      TransacaoLiquidez: {
        type: 'object',
        properties: {
          id: { type: 'string', format: 'uuid' },
          hotelId: { type: 'string', format: 'uuid' },
          fornecedor: { type: 'string', example: 'Fornecedor Financeiro Teste' },
          tipoDocumento: { type: 'string', example: 'Invoice' },
          documentoNumber: { type: 'string', example: 'NF-0001' },
          vencimento: { type: 'string', format: 'date-time' },
          categoria: { type: 'string', example: 'marketing' },
          notaInterna: { type: 'string', nullable: true, example: 'Lançamento criado pelo script de teste' },
          ...
          arquivo: {
            ...
            nullable: true,
            properties: {
              nome: { type: 'string', example: 'nota.pdf' },
              tipo: { type: 'string', example: 'application/pdf' },
              tamanho: { type: 'integer', example: 1024 },
            },
          },
        },
      },
      GestaoLiquidez: {
        type: 'object',
        properties: {
          saldoAtualConsolidado: { type: 'number', format: 'float', example: 482930.5 },
          projecaoDeCresimentoEstimado: { type: 'number', format: 'float', example: 542000.0 },
          variacaoUltimos30DiasPercentual: { type: 'number', format: 'float', example: 12.5 },
          transacoesRecentes: { type: 'array', items: { $ref: '#/components/schemas/FinanceiroTransacao' } },
        },
      },
      PoliciesTiming: {
        type: 'object',
  ...
  paths: {
    ...
    '/hotel/{hotelId}/hospedes/{id}/refeicoes': {
      get: {
        tags: ['Hóspedes', 'Refeições do Hotel'],
        summary: 'Listar refeições já participadas pelo hóspede',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string' } },
          { name: 'id', in: 'path', required: true, schema: { type: 'string' } },
        ],
        responses: {
          200: { description: 'Refeições listadas.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean' }, dados: { type: 'array', items: { type: 'object' } } } } } } },
          404: { description: 'Hóspede não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },

    '/hotel/{hotelId}/hospedes/{id}/refeicoes/{pedidoConsumoId}': {
      patch: {
        tags: ['Hóspedes', 'Refeições do Hotel'],
        summary: 'Atualizar presença de uma refeição do hóspede',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string' } },
          { name: 'id', in: 'path', required: true, schema: { type: 'string' } },
          { name: 'pedidoConsumoId', in: 'path', required: true, schema: { type: 'string' } },
        ],
        requestBody: {
          content: {
            'application/json': {
        ...
        responses: {
          200: { description: 'Presença atualizada.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean' }, dados: { type: 'object' } } } } } },
          404: { description: 'Hóspede ou presença não encontrada.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    ...
    '/hoteis/{id}/refeicoes/{refeicaoId}/presenca': {
      post: {
        tags: ['Refeições do Hotel'],
        summary: 'Marcar presença de hóspede na refeição',
        description: 'Registra presença vinculada a uma reserva. Não permite duplicidade para a mesma combinação de hóspede + reserva + refeição no mesmo dia.',
        parameters: [
          { name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' }, description: 'ID do hotel' },
          { name: 'refeicaoId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' }, description: 'ID da refeição' },
        ],
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['hospede_id', 'reserva_id'],
                properties: {
                  hospede_id: { type: 'string', format: 'uuid', example: '2c70ad90-7fec-4a5f-8db6-6e58c2f8f0f0' },
                  reserva_id: { type: 'string', format: 'uuid', example: '48D1D43E-AFBC-4C83-85C0-C9D1521B48A8' },
                  presente: { type: 'boolean', example: true, default: true },
                  data: { type: 'string', format: 'date-time', example: '2026-05-12T08:15:00.000Z' },
                },
              },
            },
            'multipart/form-data': {
              schema: {
                ...
                required: ['hospede_id', 'reserva_id'],
                properties: {
                  hospede_id: { type: 'string', format: 'uuid' },
        ...
        responses: {
          ...
          400: { description: 'Dados inválidos.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          409: { description: 'Presença já registrada para esta refeição nessa estadia e data.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Hotel, refeição, hóspede ou reserva não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          401: { description: 'Não autorizado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },

    '/hoteis/{id}/refeicoes/{refeicaoId}/presensa': {
      post: {
        tags: ['Refeições do Hotel'],
        summary: 'Marcar presença de hóspede na refeição',
        description: 'Alias compatível com a grafia presensa. Registra presença vinculada a uma reserva e não permite duplicidade no mesmo dia.',
        parameters: [
          { name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' }, description: 'ID do hotel' },
          { name: 'refeicaoId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' }, description: 'ID da refeição' },
        ],
    ...
    // RESERVAS
    // ─────────────────────────────────────────────────────────────────────────
    '/hotel/{hotelId}/reservas': {
      get: {
        tags: ['Reservas'],
        summary: 'Listar reservas do hotel',
        description: 'Retorna todas as reservas de um hotel com dados de hóspede e quarto.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' }, example: 'FB5D45CD-0C6A-4C4C-B10B-B44875ACDFCC' },
        ],
        responses: {
          200: { description: 'Lista de reservas.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, dados: { type: 'array', items: { $ref: '#/components/schemas/Reserva' } } } } } } },
          404: { description: 'Hotel não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
      post: {
        ...
        description: 'Cria uma reserva para um hóspede em um quarto do hotel.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' }, example: 'FB5D45CD-0C6A-4C4C-B10B-B44875ACDFCC' },
        ],
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['hospede_id', 'quarto_id', 'data_checkin', 'data_checkout', 'valor'],
                properties: {
                  hospede_id: { type: 'string', format: 'uuid', example: '9825D286-1C60-4497-B1BF-076D0470BF52' },
                  quarto_id: { type: 'string', format: 'uuid', example: '187B44C0-9BA1-4F43-9165-A29BB11C1248' },
                  data_checkin: { type: 'string', format: 'date', example: '2026-05-12' },
                  data_checkout: { type: 'string', format: 'date', example: '2026-05-15' },
                  valor: { type: 'number', format: 'float', example: 1350.00 },
                  qtd_adultos: { type: 'integer', default: 1, example: 2 },
                  qtd_criancas: { type: 'integer', default: 0, example: 0 },
                  canal: { type: 'string', default: 'website', example: 'website' },
                },
              },
            },
          },
        ...
        responses: {
          201: { description: 'Reserva criada com sucesso.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, mensagem: { type: 'string' }, dados: { $ref: '#/components/schemas/Reserva' } } } } } },
    ...
    '/reservas/hospede/{hospedeId}': {
      get: {
        tags: ['Reservas'],
        summary: 'Listar reservas por hóspede',
        parameters: [
          { name: 'hospedeId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' }, example: '9825D286-1C60-4497-B1BF-076D0470BF52' },
        ],
        responses: {
          200: { description: 'Reservas do hóspede.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean' }, dados: { type: 'array', items: { $ref: '#/components/schemas/Reserva' } } } } } } },
        },
      },
    },
    ...
    '/reservas/{id}': {
      get: {
        ...
        parameters: [
          { name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' }, example: '48D1D43E-AFBC-4C83-85C0-C9D1521B48A8' },
        ],
        responses: {
          200: { description: 'Dados da reserva.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean' }, dados: { $ref: '#/components/schemas/Reserva' } } } } } },
          404: { description: 'Reserva não encontrada.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
      patch: {
        tags: ['Reservas'],
        summary: 'Atualizar reserva',
        description: 'Atualiza qualquer campo da reserva. Todos os campos são opcionais.',
        parameters: [
          ...
          content: {
            'application/json': {
              schema: {
                ...
                properties: {
                  hospede_id: { type: 'string', format: 'uuid' },
                  quarto_id: { type: 'string', format: 'uuid' },
                  data_checkin: { type: 'string', format: 'date' },
                  data_checkout: { type: 'string', format: 'date' },
                  valor: { type: 'number', format: 'float' },
                  qtd_adultos: { type: 'integer' },
                  qtd_criancas: { type: 'integer' },
                  status: { type: 'string', enum: ['confirmada', 'check-in', 'check-out', 'cancelada', 'no-show'] },
                  canal: { type: 'string' },
                },
              },
            },
        ...
        responses: {
          200: { description: 'Reserva atualizada.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean' }, mensagem: { type: 'string' }, dados: { $ref: '#/components/schemas/Reserva' } } } } } },
          400: { description: 'Nenhum campo para atualizar.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Reserva não encontrada.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
      delete: {
        ...
        responses: {
          200: { description: 'Reserva deletada.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean' }, mensagem: { type: 'string' } } } } } },
          404: { description: 'Reserva não encontrada.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    ...
    '/reservas/{id}/status': {
      patch: {
        ...
        description: 'Atualiza apenas o status. Valores válidos: `confirmada`, `check-in`, `check-out`, `cancelada`, `no-show`.',
        parameters: [
          { name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' }, example: '48D1D43E-AFBC-4C83-85C0-C9D1521B48A8' },
        ],
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                ...
                required: ['status'],
                properties: {
                  status: { type: 'string', enum: ['confirmada', 'check-in', 'check-out', 'cancelada', 'no-show'], example: 'check-in' },
                },
              },
            },
          },
        ...
        responses: {
          200: { description: 'Status atualizado.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean' }, mensagem: { type: 'string' }, dados: { $ref: '#/components/schemas/Reserva' } } } } } },
          400: { description: 'Status inválido ou ausente.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Reserva não encontrada.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    ...
    // FINANCEIRO
    // ─────────────────────────────────────────────────────────────────────────
    '/hotel/{hotelId}/financeiro/transacoes': {
      get: {
        tags: ['Financeiro'],
        summary: 'Listar transações financeiras do hotel',
        description: 'Retorna transações recentes do módulo financeiro. A API também aceita o alias /hotel/{hotelId}/finaceiro/transacoes.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
          { name: 'limit', in: 'query', required: false, schema: { type: 'integer', default: 50, minimum: 1, maximum: 200 } },
        ],
        responses: {
          200: { description: 'Transações listadas.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, dados: { type: 'array', items: { $ref: '#/components/schemas/FinanceiroTransacao' } } } } } } },
          404: { description: 'Hotel não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    '/hotel/{hotelId}/financeiro/receitatotal': {
      get: {
        tags: ['Financeiro'],
        summary: 'Obter receita total do hotel',
        description: 'Calcula receita total agregando hospedagem, extras e receitas manuais. A API também aceita o alias /hotel/{hotelId}/finaceiro/receitatotal.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
        ...
        responses: {
          200: { description: 'Receita total calculada.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, dados: { type: 'object', properties: { periodo: { type: 'object' }, receitaTotal: { type: 'number', format: 'float' }, receitaHospedagem: { type: 'number', format: 'float' }, receitaExtras: { type: 'number', format: 'float' }, receitasManuais: { type: 'number', format: 'float' } } } } } } } },
          400: { description: 'Período inválido.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Hotel não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    '/hotel/{hotelId}/financeiro/revpar': {
      get: {
        tags: ['Financeiro'],
        summary: 'Obter RevPAR do hotel',
        description: 'Calcula RevPAR com base na receita de quartos e capacidade disponível. A API também aceita o alias /hotel/{hotelId}/finaceiro/revpar.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
          { name: 'dataInicio', in: 'query', schema: { type: 'string', format: 'date' } },
          { name: 'dataFim', in: 'query', schema: { type: 'string', format: 'date' } },
          { name: 'andarId', in: 'query', schema: { type: 'string', format: 'uuid' } },
        ],
        responses: {
          200: { description: 'RevPAR calculado.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, dados: { type: 'object', properties: { periodo: { type: 'object' }, totalQuartos: { type: 'integer' }, diasPeriodo: { type: 'integer' }, revpar: { type: 'number', format: 'float' } } } } } } } },
          400: { description: 'Período inválido.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Hotel não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    '/hotel/{hotelId}/financeiro/ocupacaomedia': {
      get: {
        tags: ['Financeiro'],
        summary: 'Obter ocupação média do hotel',
        description: 'Calcula a ocupação média no período. A API também aceita o alias /hotel/{hotelId}/finaceiro/ocupacaomedia.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
          { name: 'dataInicio', in: 'query', schema: { type: 'string', format: 'date' } },
          { name: 'dataFim', in: 'query', schema: { type: 'string', format: 'date' } },
        ...
        responses: {
          200: { description: 'Ocupação média calculada.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, dados: { type: 'object', properties: { periodo: { type: 'object' }, totalQuartos: { type: 'integer' }, diasPeriodo: { type: 'integer' }, ocupacaoMedia: { type: 'number', format: 'float' } } } } } } } },
          400: { description: 'Período inválido.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Hotel não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    '/hotel/{hotelId}/financeiro/lucroliquido': {
      get: {
        tags: ['Financeiro'],
        summary: 'Obter lucro líquido do hotel',
        description: 'Calcula lucro líquido a partir das receitas operacionais e das despesas manuais. A API também aceita o alias /hotel/{hotelId}/finaceiro/lucroliquido.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
          { name: 'dataInicio', in: 'query', schema: { type: 'string', format: 'date' } },
          { name: 'dataFim', in: 'query', schema: { type: 'string', format: 'date' } },
        ...
        responses: {
          200: { description: 'Lucro líquido calculado.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, dados: { type: 'object', properties: { periodo: { type: 'object' }, lucroLiquido: { type: 'number', format: 'float' }, receitaTotal: { type: 'number', format: 'float' }, despesasManuais: { type: 'number', format: 'float' } } } } } } } },
          400: { description: 'Período inválido.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Hotel não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    '/hotel/{hotelId}/financeiro/faturamento-quartos': {
      get: {
        tags: ['Financeiro'],
        summary: 'Obter faturamento de quartos',
        description: 'Retorna receita total diária, RevPAR, ocupação média, ADR e detalhamento por estadia. A API também aceita o alias /hotel/{hotelId}/finaceiro/faturamento-quartos.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
          { name: 'dataInicio', in: 'query', schema: { type: 'string', format: 'date' } },
          { name: 'dataFim', in: 'query', schema: { type: 'string', format: 'date' } },
        ...
        responses: {
          200: { description: 'Faturamento de quartos calculado.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, dados: { type: 'object', properties: { periodo: { type: 'object' }, totalQuartos: { type: 'integer' }, diasPeriodo: { type: 'integer' }, receitaTotalDiaria: { type: 'number', format: 'float' }, revpar: { type: 'number', format: 'float' }, ocupacaoMedia: { type: 'number', format: 'float' }, adr: { type: 'number', format: 'float' }, detalhamentoPorEstadia: { type: 'array', items: { $ref: '#/components/schemas/FinanceiroDetalhamentoEstadia' } } } } } } } } },
          400: { description: 'Período inválido.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Hotel não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    '/hotel/{hotelId}/financeiro/gestao-liquidez': {
      get: {
        tags: ['Financeiro'],
        summary: 'Obter gestão de liquidez',
        description: 'Retorna saldo atual consolidado, projeção estimada e transações recentes. A API também aceita o alias /hotel/{hotelId}/finaceiro/gestao-liquidez.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
          { name: 'limit', in: 'query', required: false, schema: { type: 'integer', default: 20, minimum: 1, maximum: 200 } },
        ],
        responses: {
          200: { description: 'Gestão de liquidez calculada.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, dados: { $ref: '#/components/schemas/GestaoLiquidez' } } } } } },
          404: { description: 'Hotel não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
      post: {
        tags: ['Financeiro'],
        summary: 'Criar lançamento manual de liquidez',
        description: 'Cria uma transação manual de liquidez. A API também aceita o alias /hotel/{hotelId}/finaceiro/gestao-liquidez.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
        ],
        requestBody: {
          ...
          content: {
            'multipart/form-data': {
              schema: {
                type: 'object',
                required: ['fornecedor', 'tipoDocumento', 'documentoNumber', 'vencimento', 'categoria', 'valor'],
                properties: {
                  fornecedor: { type: 'string', example: 'Fornecedor Financeiro Teste' },
                  tipoDocumento: { type: 'string', example: 'Invoice' },
                  documentoNumber: { type: 'string', example: 'NF-0001' },
                  vencimento: { type: 'string', format: 'date-time' },
                  categoria: { type: 'string', example: 'marketing' },
                  notaInterna: { type: 'string', example: 'Lançamento manual criado pelo front' },
                  valor: { type: 'number', format: 'float', example: 150.0 },
                  tipo: { type: 'string', example: 'despesa' },
                  status: { type: 'string', example: 'pendente' },
        ...
        responses: {
          201: { description: 'Transação criada.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, mensagem: { type: 'string' }, dados: { $ref: '#/components/schemas/TransacaoLiquidez' } } } } } },
          400: { description: 'Payload inválido.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Hotel não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    '/hotel/{hotelId}/financeiro/gestao-liquidez/{transacaoId}': {
      patch: {
        tags: ['Financeiro'],
        summary: 'Atualizar lançamento de liquidez',
        description: 'Atualiza um lançamento manual de liquidez. A API também aceita o alias /hotel/{hotelId}/finaceiro/gestao-liquidez/{transacaoId}.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
          { name: 'transacaoId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
        ],
        requestBody: {
          required: true,
          content: {
        ...
        responses: {
          200: { description: 'Transação atualizada.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, mensagem: { type: 'string' }, dados: { $ref: '#/components/schemas/TransacaoLiquidez' } } } } } },
          400: { description: 'Payload inválido.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Hotel ou transação não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
      delete: {
        tags: ['Financeiro'],
        summary: 'Remover lançamento de liquidez',
        description: 'Remove um lançamento manual de liquidez. A API também aceita o alias /hotel/{hotelId}/finaceiro/gestao-liquidez/{transacaoId}.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
          { name: 'transacaoId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
        ],
        responses: {
          200: { description: 'Transação removida.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, mensagem: { type: 'string' }, dados: { type: 'object', properties: { id: { type: 'string', format: 'uuid' } } } } } } } },
          404: { description: 'Hotel ou transação não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
    },
    '/hotel/{hotelId}/financeiro/faturamento-extras': {
      get: {
        tags: ['Financeiro'],
        summary: 'Obter faturamento com extras',
        description: 'Retorna receita agrupada por A&B, SPA e outros serviços, além dos lançamentos. A API também aceita o alias /hotel/{hotelId}/finaceiro/faturamento-extras.',
        parameters: [
          { name: 'hotelId', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } },
          { name: 'dataInicio', in: 'query', schema: { type: 'string', format: 'date' } },
          { name: 'dataFim', in: 'query', schema: { type: 'string', format: 'date' } },
        ...
        responses: {
          200: { description: 'Faturamento com extras calculado.', content: { 'application/json': { schema: { type: 'object', properties: { sucesso: { type: 'boolean', example: true }, dados: { type: 'object', properties: { periodo: { type: 'object' }, receitaAB: { type: 'number', format: 'float' }, receitaSPA: { type: 'number', format: 'float' }, outrosServicos: { type: 'number', format: 'float' }, lancamentos: { type: 'array', items: { type: 'object', properties: { data: { type: 'string', format: 'date-time' }, descricao: { type: 'string' }, tipo: { type: 'string' }, status: { type: 'string' }, valor: { type: 'number', format: 'float' }, hospede: { type: 'string' } } } } } } } } } } },
          400: { description: 'Período inválido.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
          404: { description: 'Hotel não encontrado.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Erro' } } } },
        },
      },
